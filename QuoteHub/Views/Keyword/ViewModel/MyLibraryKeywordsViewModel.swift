//
//  MyLibraryKeywordsViewModel.swift
//  QuoteHub
//
...
@MainActor
@Observable
final class MyLibraryKeywordsViewModel: LoadingViewModelProtocol {
    ...
    private let myBookStoriesViewModel: MyBookStoriesViewModel
    
    // MARK: - Task Management
    private var processingTask: Task<Void, Never>?
    
    // MARK: - Initialization
    init(myBookStoriesViewModel: MyBookStoriesViewModel) {
        self.myBookStoriesViewModel = myBookStoriesViewModel
...
extension MyLibraryKeywordsViewModel {
...
extension MyLibraryKeywordsViewModel {
    ...
    private func performProcessKeywords() async {
        ...
        do {
            ...
            // 모든 북스토리에서 키워드 추출
            let keywordCounts = extractKeywordCounts(from: myBookStoriesViewModel.bookStories)
    ...
    private func handleError(_ error: Error) {
        ...
        print("❌ MyLibraryKeywordsViewModel 에러: \(error)")
    }
}
