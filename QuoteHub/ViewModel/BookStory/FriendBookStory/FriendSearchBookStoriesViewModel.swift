//
//  FriendSearchBookStoriesViewModel.swift
//  QuoteHub
//
...
@MainActor
@Observable
final class FriendSearchBookStoriesViewModel: BookStoriesViewModelProtocol {
    ...
    // MARK: - Initialization
    init(friendId: String, keyword: String, service: BookStoryServiceProtocol = BookStoryService()) {
...
//    }
    ...
    private func performLoadBookStories() async {
        ...
        do {
            let response = try await service.fetchFriendBookStoriesByKeyword(
                friendId: friendId,
                keyword: keyword,
                page: currentPage,
                pageSize: pageSize
    ...
    private func handleError(_ error: Error) {
        ...
        print("❌ FriendSearchBookStoriesViewModel 에러: \(error)")
    }
}
